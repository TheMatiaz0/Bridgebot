...
{    public static class GameObjectExtensionE
    {
        ...
        public static RaycastHit2D Ray2DWithoutThis(this GameObject gameObject,Vector2 from, Direction dir, float distance)
        {
            return Physics2D.RaycastAll(from, dir, distance)
                .FirstOrDefault(item => item.collider != null && item.collider.gameObject != gameObject.gameObject);
        }
