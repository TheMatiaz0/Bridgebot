...
namespace Cyberevolver.Unity
{
	...
	/// </summary>
	[Serializable]
	public struct SerializedTimeSpan : ISerializationCallbackReceiver
	{
		[SerializeField]
		[Range(0, 999)]
		...
		public SerializedTimeSpan(TimeSpan span)
		{
			_TimeSpan = span;
		...
		public static implicit operator SerializedTimeSpan(TimeSpan span)
		{
			return new SerializedTimeSpan(span);
		}
