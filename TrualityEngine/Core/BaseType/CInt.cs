...
namespace TrualityEngine.Core
{
    ...
    /// It is like <see cref="uint"/> but it is imposible to jump from the lowest value to the highest value or inversely.
    /// Example, if you have "0" as value, and then you decrement it, you will still have 0.
    /// It has implemented classic numbers operator and implict convert to int in two direction.
    /// </summary>
    [Serializable]
    public struct Cint : IComparable, IFormattable, IConvertible, IComparable<UInt32>, IEquatable<UInt32>, IComparable<Cint>, IEquatable<Cint>
    {
        ...
        /// <summary>
        /// Default value, which you can use as default parameter.
        /// </summary>
        public static readonly Cint Zero = new Cint();
        /// <summary>
        /// Max <see cref="Cint"/> value is identic to max <see cref="uint"/> value.
        /// </summary>
